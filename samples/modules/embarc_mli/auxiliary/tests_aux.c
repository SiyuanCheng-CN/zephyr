...
//=================================================================================
enum test_status load_tensors_from_idx_files(
...
/* -------------------------------------------------------------------------- */
enum test_status measure_ref_to_pred(
...
/* -------------------------------------------------------------------------- */
enum test_status measure_err_vfloat(
        const float * ref_vec,
...
enum test_status fill_asym_tensor_element_params(
