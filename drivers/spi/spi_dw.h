...
#define CHECK_AUX(n) DT_NODE_HAS_STATUS(DT_DRV_INST(n), okay)&DT_INST_PROP(n, aux_reg)
#define CHECK_MM(n) DT_NODE_HAS_STATUS(DT_DRV_INST(n), okay)&!DT_INST_PROP(n, aux_reg)

#if CHECK_AUX(0) || CHECK_AUX(1) || CHECK_AUX(2) || CHECK_AUX(3)
...
#if CHECK_MM(0) || CHECK_MM(1) || CHECK_MM(2) || CHECK_MM(3)
